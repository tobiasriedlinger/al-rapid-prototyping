...
splits = dict(
    ...
    validation=dict(size=0),
    train_track=dict(size=0),
    query=dict(
        pool_size=2000,
        method='dropout',
        n_samples=10,
        ...
        ratio=None,
        score_thr=0.5))
al_run = dict(run_count=0, initial_step=0, total_num_counts=1)
metrics = False

output_dir = "/home/USR/active_learning/results/al_runs/retinanet"