...
data = dict(
    ...
    test=dict(
        ...
        img_prefix=
        '/home/datasets/PASCAL_VOC/test/VOCdevkit/VOC2007/JPEGImages',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
splits = dict(
    ...
    query=dict(
        ...
        ratio=None,
        score_thr=0.5))
al_run = dict(run_count=0, initial_step=0, total_num_counts=16)
metrics = False
output_dir = '/home/USR/mm-detection-active-learning-for-object-detection/results/al_runs/yolov3'
