...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/home/USR/darknet20_coco.pth')),
    neck=dict(
        type='YOLOV3Neck',
        num_scales=3,
...
output_dir = "/home/USR/mm-detection-active-learning-for-object-detection/checkpoints/yolov3_dn20"
