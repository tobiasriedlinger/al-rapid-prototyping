...
data_root = '/home/USR/active_learning/mm-detection-active-learning-for-object-detection/checkpoints/bdd_annotations/'
img_norm_cfg = dict(
...
evaluation = dict(interval=170000, metric=['bbox'])
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
...
output_dir = "/home/USR/active_learning/results/al_runs/frcnn"
work_dir = "/home/USR/active_learning/results/al_runs/frcnn"