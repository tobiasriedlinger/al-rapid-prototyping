...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/home/USR/mm-detection-active-learning-for-object-detection/checkpoints/faster_rcnn/r101_fpn.pth')
        ),
    neck=dict(
        type='FPN',
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix='/home/datasets/bdd100k/images/100k/train',
    ...
    val=dict(
        ...
        img_prefix='/home/datasets/bdd100k/images/100k/val',
...
runner = dict(type='IterBasedRunner', max_iters=170000)
...
lr_config = dict(
    ...
    step=[120000, 160000])
splits = dict(
    initial=dict(size=1250, ratio=None),
    validation=dict(size=200),
    train_track=dict(size=200),
    query=dict(
        pool_size=2000,
        ...
        ratio=None,
        score_thr=0.7))
al_run = dict(run_count=0, initial_step=0, total_num_counts=5)
output_dir = '/home/USR/results_aggr/al_runs/frcnn'
work_dir = '/home/USR/results_aggr/al_runs/frcnn'
gpu_ids = range(0, 1)
